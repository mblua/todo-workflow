...
2. GitHub Issues 10-step workflow
...
| `template/hooks/pre-commit` | Enforcement hook that validates checklist before commits. |
...
| `docs/WORKFLOW_DIAGRAM.md` | Mermaid diagrams of all four systems. |
| `docs/EXAMPLES.md` | Real-world usage examples including enforcement examples. |
...
- **MAJOR** (X.0.0): Breaking changes (placeholder renames, step reordering, removed sections)
...
- [ ] Checklist format in template matches what the hook parses
